package com.kevin.catalogservice.web;

import com.kevin.catalogservice.domain.Book;
import com.kevin.catalogservice.domain.BookRepository;
...
public class BookController {
    ...
    public Book insertBook(@Valid @RequestBody Book book) {
        var b = bookService.addBookToCatalog(book);
        return b;//bookService.addBookToCatalog(book);
    }
